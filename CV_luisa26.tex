...
\mainbar{
    ...
    \textit{Pesquisadora de Pós-Graduação}\\
    \vspace{-0.4cm}
    \begin{itemize}[leftmargin=0.4cm, topsep=0pt, itemsep=2pt]
        \item \small Coordenar análise de dados observacionais de grandes levantamentos astronômicos.
        \item \small Publicar artigos científicos em revistas internacionais de alto impacto
\end{itemize}
