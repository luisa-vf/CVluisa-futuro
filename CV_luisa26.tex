...
\highlightbar{
    ...
    \skill{Visualização}{3}
    (e.g. matplotlib, ...)\\
    \skill{Analise de dados}{3}
    (e.g. numpy, pandas, ...)\\
    \skill{Office}{4}
...
\mainbar{
    \section{Resumo}
    Graduanda em Astronomia pelo Observatório do Valongo (UFRJ), atualmente no 5º período. Bolsista de Iniciação Científica com experiência no desenvolvimento de projetos de pesquisa, análise de dados estatísticos e programação em Python. Interessada nas áreas de Astrofísica, análise de dados e divulgação científica.
